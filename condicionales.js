...
let secondGrade = parseFloat(prompt("Introduce tu calificación del segundo trimestre"));
let thirdGrade = parseFloat(prompt("Introduce tu calificación del tercer trimestre"));
...
let numOne = parseFloat(prompt("Introduce un número"));
let squareNumber = parseFloat(prompt("Dime cuánto es el número que has introducido elevado al cuadrado"))

squareNumber === numOne * numOne ?
alert("¡Correcto! Toma una chocolatina: 🍫") : alert("¡Error! Piensa bien tu respuesta")